...
public class CheckedTasks extends ListView {
	...
	public CheckedTasks(Context context) {
		super(context);
		mContext = context;
	...
	public CheckedTasks(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		tbDbHelper = new TbDbAdapter(context);
		fillData();
	...
	public CheckedTasks(Context context, AttributeSet attrs, int defStyle) {
	...
	private void fillData() {
        ...
        SimpleCursorAdapter notes = 
        	    new SimpleCursorAdapter(mContext, R.layout.d_task_row, mUncheckedTaskCursor, from, to);
        setAdapter(notes);
