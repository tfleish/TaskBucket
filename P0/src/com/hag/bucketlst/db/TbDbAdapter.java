...
public class TbDbAdapter {
    ...
    public long makeCategory(String name) 
    {
        ...
        initialValues.put(KEY_CAT_ISEDITABLE, 1);
    ...
    {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_TASKUSER_TASKID, taskId);
        initialValues.put(KEY_TASKUSER_USERID, userId);
        
        return db.insert(DATABASE_TABLE_TASK_USER, null, initialValues);
    }
    
    public long addUser2Cat(long catId, long userId) 
    {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_CATUSER_CATID, catId);
        initialValues.put(KEY_CATUSER_USERID, userId);
        
        return db.insert(DATABASE_TABLE_CAT_USER, null, initialValues);
    }
    ...
    **/
    ...
    public boolean deleteTaskUser(long rowId) 
    {
    ...
    {
    	String str = "(" + KEY_CATUSER_CATID + "=" + rowId + ") AND (" + KEY_CATUSER_USERID + "=" + userId + ")";
        return db.delete(DATABASE_TABLE_CAT_USER, str, null) > 0;
    }
